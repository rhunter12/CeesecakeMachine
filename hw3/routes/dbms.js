...
var host = "35.185.230.30";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "11cHeEsEcAkE22";  //password (change to match your db, yes this is very poor practice)
